    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <?php echo form_open(base_url('admin/auth/register'), 'class="login-form" '); ?>
          ...
          <div class="form-group has-feedback">
            <input type="text" name="firstname" id="firstname" class="form-control" placeholder="<?= trans('firstname') ?>" >
          </div>
          <div class="form-group has-feedback">
           <input type="text" name="lastname" id="lastname" class="form-control" placeholder="<?= trans('lastname') ?>" >
          </div>
          <div class="form-group has-feedback">
