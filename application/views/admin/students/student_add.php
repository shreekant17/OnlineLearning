    ...
    <section class="content">
      <div class="card card-default">
        ...
        <div class="card-body">
         ...
         <?php echo form_open(base_url('admin/student/add'), 'class="form-horizontal"');  ?> 
        ...
        <div class="form-group">
          <div class="col-md-12">
            <input type="submit" name="submit" value="<?= trans('add_student') ?>" class="btn btn-primary pull-right">
          </div>
        </div>
        <?php echo form_close( ); ?>
      </div>
