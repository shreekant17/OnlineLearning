    ...
    <div class="container d-flex justify-content-center mt-5">
        <div class="card col-md-8">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart(base_url('instructor/edit_lesson/'.$lesson['lesson_id']), 'class="form-horizontal"');  ?> 
                    <div class="mb-3">
                        <label for="lessonName" class="form-label">Lesson Title</label>
                        <input type="text" class="form-control" id="lessonName" name="lesson_name" value="<?=$lesson['lesson_name']?>" placeholder="Enter lesson name">
                    </div>
                    ...
                    <div class="form-group d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="div">
                            <video id="preview" src="<?=base_url($lesson['video_src'])?>" class="img-thumbnail" ></video>
                        </div>
                    ...
                    <div class="form-group d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="div">
                            <img id="preview2" src="<?=base_url($lesson['video_thumbnail'])?>" class="img-thumbnail"/>
                        </div>
                    ...
                    <div class="mb-3">
                        <div class="card card-info card-outline">
                            ...
                            <div class="card-body">
                                <textarea id="editor1" name="description" style="width: 100%"><?=$lesson['description']?></textarea>
                            </div>
                        </div>
                    </div>
