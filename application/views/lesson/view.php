        ...
        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
          <div class="card">
            <div class="card-header text-white" style="background-color: #0a4275;">
              <?php if($course['instructor_id']==$this->session->userdata('instructor_id')):?>

              <?php echo form_open_multipart(base_url(''), 'id="uploadForm" class="form-horizontal"'); ?>
              <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-center" style="gap: 2px;">
                  ...
                  <input type="hidden" name="lesson_id" id="lesson_id" value="<?=$lesson['lesson_id']?>" required>
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush" style="max-height: 50vh; overflow-y: scroll;">
                  <?php foreach($all_lessons as $l):?>
                    <a href="<?=base_url('instructor/view_lesson/'.$l['lesson_id'])?>" style="text-decoration: none; cursor: pointer;">
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      $('#uploadForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url("pdf/upload_file"); ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                contentType: false,
                ...
                success: function(response) {
                    console.log(response);
                    $('#na_datatable').DataTable().destroy();
                    set_datatable();
