      ...
      <div class="card-header text-white" style="background-color: #0a4275;">
        <div class="d-flex justify-content-between align-items-center">
          <h3 class="card-title m-0"><i class="fa fa-list"></i>&nbsp; <?=$module['module_name']?> - Lessons</h3>
            <a href="<?= base_url('instructor/add_lesson/'.$module['module_id']); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Lesson</a>
        </div>
      </div>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('instructor/datatable_json_lesson/'.$module['module_id'])?>",
    "order": [[0,'asc']],
    "columnDefs": [
    ...
    { "targets": 2, "name": "module_name", 'searchable':true, 'orderable':true, 'className':'text-center'},
    { "targets": 3, "name": "course_name", 'searchable':true, 'orderable':true, 'className':'text-center'},
    { "targets": 4, "name": "instructors_name", 'searchable':true, 'orderable':true, 'className':'text-center'},
